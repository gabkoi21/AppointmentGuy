...
const ActionButton = ({
  ...
  <button
    onClick={onClick}
    className={`flex w-full items-center gap-2 rounded-md p-2 text-left transition-colors duration-200 ${colorClasses} hover);
    ...
    <div className="absolute right-0 z-10 mt-2 w-56 whitespace-nowrap rounded-md border border-gray-200 bg-white px-3 py-2 shadow-lg">
      <div className="flex flex-col gap-2 text-sm font-medium">
        <ActionButton
          ...
          text="Edit Business"
          colorClasses="text-blue-600 hover) => handleDeleteBusiness(business.id.toString())}
